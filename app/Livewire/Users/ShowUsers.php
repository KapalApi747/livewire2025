...

{
    ...
    public function forceDelete($userId)
    {
        ...
        $user->forceDelete();
        // $this->showMessage('Gebruiker' . ' ' . $user->name . ' ' . 'permanent verwijderd!', 'error');
    ...
    public function restoreUser($userId)
    {
        $user = User::withTrashed()->find($userId);
        $user->restore();
        // $this->showMessage('Gebruiker' . ' ' . $user->name . ' ' . 'hersteld!', 'success');
    ...
    public function bulkRestore()
    {
        ...
        $this->selectedUsers = [];
        $this->selectedAll = false;
        $this->showMessage($count . ' gebruikers hersteld!', 'success');
    }
    ...
    public function bulkForceDelete()
    {
        ...
        $this->selectedUsers = [];
        $this->selectedAll = false;
        $this->showMessage($count . ' gebruikers permanent verwijderd!', 'error');
    }
    ...
    public function toggleSelected($userId)
    {
